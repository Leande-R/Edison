Feature: : Create a new charging station
  ...
  Given i want to create a new Charging Station in the System
    ...
    Then i have sucessfully created a new Charging Station in "Einsteingasse 1, 8280" with the name "Fürstenfeld Charging" and the AC-price  0.25 and the DC-Price 0.35
